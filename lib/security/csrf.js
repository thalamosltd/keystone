...
console.log('Keystone DISABLE_CSRF', DISABLE_CSRF);
...
exports.createToken = function (req) {
	console.log('Keystone createToken');
...
exports.requestToken = function (req) {
	console.log('Keystone requestToken');
...
exports.validate = function (req, token) {
	...
	console.log('Keystone validate DISABLE_CSRF', DISABLE_CSRF);
...
exports.middleware = {
	...
	validate: function (req, res, next) {
		console.log('Keystone middleware validate DISABLE_CSRF', DISABLE_CSRF);
		// Allow environment variable to disable check
